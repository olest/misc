tracks = LOAD 'lastfm-dataset-1K/userid-timestamp-artid-artname-traid-traname.tsv' AS (
user_id,
timestamp,
mb_artist_id,
artist_name,
...
users = LOAD 'lastfm-dataset-1K/userid-profile.tsv' AS (
user_id,
gender,
age: int,
country,
...
users_tracks_samples = LIMIT users_tracks 10;

DUMP users_tracks_samples;

users_tracks_data = FOREACH users_tracks GENERATE users_data::user_id, country, gender,age, artist_name, track_name;

STORE users_tracks_data INTO 'lastfm-dataset-1K/users_tracks_data.tsv';
